	...
	if (resource.resources) {
		Object.keys(resource.resources).forEach(function(rkey) {
			...
			if (!child) {
				...
				var obj = resource.resources[rkey];
				if (obj === true) obj = undefined;
				child = raja.create({key: rkey}, obj);
			}
			if (!child.parents) {
				child.parents = {};
			}
	...
	if (resource.parents) {
		Object.keys(resource.parents).forEach(function(rkey) {
			...
			if (!parent) {
				...
				var obj = resource.parents[rkey];
				if (obj === true) obj = undefined;
				parent = raja.create({key: rkey}, obj);
			}
			if (!parent.resources) {
				parent.resources = {};
			}
...
function saveRelations(inst, hash, cb) {
	...
	keys.forEach(function(key) {
		q.defer(self.store.bind(self), key, {});
	});
